...
xcodebuild -workspace DummySpit.xcworkspace -scheme DummySpit -sdk iphonesimulator8.1 -destination 'platform=iOS Simulator,name=iPhone 6,OS=8.1' clean build test | xcpretty
