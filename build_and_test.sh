...
xcodebuild -workspace DummySpit.xcworkspace -scheme DummySpit -sdk iphonesimulator8.0 -destination 'platform=iOS Simulator,name=iPhone Retina (4-inch),OS=8.0' clean build test | xcpretty
