...
set -o pipefail && xcrun xcodebuild -project DummySpit.xcodeproj -scheme DummySpit -sdk iphonesimulator8.4 -destination 'platform=iOS Simulator,name=iPhone 6,OS=8.4' clean build test | xcpretty -c
